...
def parse_args(args_input):
    ...
    parser.add_argument('--distribution', default=None, choices=['neg_bin', 'gaus'], help='distribution assumed for the measurement data')
    parser.add_argument('--data_trans', default=None, choices=['sf', 'log', 'none'], help='change transformation scheme for measurement data')
    parser.add_argument('--noise_factor', default=None, type=float, help='noise applied for denoising autoencoder')
    parser.add_argument('--loss_dis', default=None, choices=['neg_bin', 'gaus'], help='loss distribution used for training')
    parser.add_argument('--prepro', default=None, choices=['none', 'sf_log2'], help='preprocess data before input')
