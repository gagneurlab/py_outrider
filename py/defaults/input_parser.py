...
def parse_args(args_input):
    ...
    parser.add_argument('--file_meas', type=str, help='path to measurement file, like gene counts' )#, required=True ) TODO CHANGE
    ...
    parser.add_argument('--profile_norm', default=None, choices=['sf', 'log2'], help='change normalization scheme for measurement data')
