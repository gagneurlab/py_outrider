...
def main():
    ...
    if args['file_meas'] is not None:    # if new tables are given, otherwise execute example
        ...
        args2 = { "file_meas" : folder_path+"counts_raw.csv", "encod_dim": None, 'verbose':True, 'num_cpus':5, 'seed':5,
        ...
        args2 = { "file_meas" : folder_path+"tmt_0_1.csv", "encod_dim": None, 'verbose':True, 'num_cpus':5,
